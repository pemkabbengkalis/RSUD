                        ...
                        <div class="widget ">
                            ...
                            <div class="widget widget_categories">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(url($row->url)); ?>"><?php echo e($row->name); ?></a> (<?php echo e($row->total_posts); ?>)</li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\cmsv2\templates/newzona/sidebar.blade.php ENDPATH**/ ?>