  ...
  <ul class="nav nav-tabs">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="home">
                  ...
                  <?php if($r[1]=='deskripsi_organisasi'): ?>
                <textarea required type="text" class="form-control form-control-sm" placeholder="Masukkan <?php echo e($r[0]); ?>" name="<?php echo e($r[1]); ?>"><?php echo e(get_option($r[1])); ?></textarea>
                  <?php else: ?>
...
<?php echo $__env->make('admin.layout.app',['title'=>'Pengaturan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cmsv2\app\View/admin/setting.blade.php ENDPATH**/ ?>