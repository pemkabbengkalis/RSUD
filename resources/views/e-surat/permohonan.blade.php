...
<div class="wrapper">
    <form action="">
    <center> <h3 class="mt-4 m-0">Formulir E-Surat</h3> </center>
        ...
        <div id="wizard">
            ...
            <section>
            <div class="form-row"> 
                    <input type="text" class="form-control" placeholder="Nomor Identitas Kependudukan">
                 </div>
                <div class="form-row"> 
                ...
                <div class="form-row">
                     <input type="text" class="form-control" placeholder="Nomor HP / Whatsapp"> 
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row" style="margin-bottom: 18px"> <textarea name="" id="" class="form-control" placeholder="Alamat lengkap" style="height: 108px"></textarea> </div>
                    <div class="form-row"> 
            ...
            <section>
                <div class="form-row"> 
                    <select name="" class="form-control" id="">
                        ...
                        <option value="">Surat Keterangan Tidak Mampus</option>
                        <option value="">Surat Domisili</option>
                        <option value="">Surat Pengantar Nikah</option>
                    </select>
                </div>
            ...
            <section>
                <div class="product">
                    <input type="checkbox" name="" id=""> Saya menyetujui dengan kebijakan dan ketentuan yang berlaku pada Aplikasi E-Surat Milik {{get_option('nama_organisasi')}} <br><br>Klik Lanjut jika data yang di input sudah benar, klik sebelumnya jika ingin memperbaiki data.
                    <!-- <div class="item">
